...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	TCHAR szAppName[] = TEXT("My_OGL_Ortho_Polygon");

	int initialize(void);
	void display(void);

	if (fopen_s(&gpFile, "My_OGL_Ortho_Polygon.txt", "w") != 0)
	{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("My_OGL_Ortho_Polygon"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
