...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	TCHAR szAppName[] = TEXT("OGL_3D_Pyramid_Texture");

	int initialize(void);
	void display(void);
	void update(void);

	if (fopen_s(&gpFile, "OGL_3D_Pyramid_Texture.txt", "w") != 0)
	{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("OGL_3D_Pyramid_Texture"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
int initialize()
{
	...
	LoadTexture(&texture_stone, MAKEINTRESOURCE(MYBITMAPPYRAMID));
	LoadTexture(&texture_kundali, MAKEINTRESOURCE(MYBITMAPKUNDALI));
