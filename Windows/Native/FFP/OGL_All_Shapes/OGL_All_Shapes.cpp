...
void display(void)
{
	static GLfloat aside, bside, semiperimeter, cside, area,radius,xside,yside, xColor,yColor,zColor;
	GLfloat
		x1 = 0.0f,
		y1 = 1.0f,
		x2 = -1.0f,
	...
	glColor3f(0.0f, 1.0f, 1.0f);
	glVertex3f(0.027f, 1.0f, 0.0f);

	glColor3f(0.0f, 1.0f, 1.0f);
	glVertex3f(0.027f, -1.0f, 0.0f);

	for (double i = 1.0f; i >= i / 40; i = i - 0.040)
	{
		glColor3f(2.0f, 0.5f, 1.0f);
		glVertex3f((GLfloat)(i + 0.025), 1.0f, 0.0f);
		glColor3f(2.0f, 0.5f, 1.0f);
		glVertex3f((GLfloat)(i + 0.025), -1.0f, 0.0f);
	}
	...
	{
		glColor3f(2.0f, 0.5f, 1.0f);
		glVertex3f((GLfloat)(-i + 0.030), 1.0f, 0.0f);
		glColor3f(2.0f, 0.5f, 1.0f);
		glVertex3f((GLfloat)(-i + 0.030), -1.0f, 0.0f);
	}
	...
	for (double i = 1.0f; i >= i / 40; i = i - 0.040)
	{
		...
		glVertex3f(1.0f, (GLfloat)(-i + 0.020), 0.0f);
		glColor3f(1.0f, 0.5f, 0.0f);
		glVertex3f(-1.0f, (GLfloat)(-i + 0.020), 0.0f);
	}
	...
	{
		glColor3f(1.0f, 0.5f, 0.0f);
		glVertex3f(1.0f, (GLfloat)(i + 0.030), 0.0f);
		glColor3f(1.0f, 0.5f, 0.0f);
		glVertex3f(-1.0f, (GLfloat)(i + 0.030), 0.0f);
	}
	glEnd();
	...
	for (GLfloat i = 0.0f; i < 2 * M_PI; i += 0.0001f)
	{
