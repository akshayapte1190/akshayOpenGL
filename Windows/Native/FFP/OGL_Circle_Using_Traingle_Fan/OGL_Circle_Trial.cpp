...
void reshape(int width, int height)
{
	...
	glViewport(200, 50, (GLsizei)WIN_WIDTH, (GLsizei)WIN_WIDTH);
	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
	gluPerspective(0.0f, (GLfloat)width / (GLfloat)height, 0.0f, 10.0f);
...
void display(void)
{
	...
	for (double angle = 0.0f; angle < 360; angle = angle + 0.001f)
	{
