...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprevInstance, LPSTR lpCndLine, int nCmdShow)
{
	...
	hwnd = CreateWindow(AppName, TEXT("First OpenGL Native Window - Akshay Apte"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);
	ghwnd =hwnd;
