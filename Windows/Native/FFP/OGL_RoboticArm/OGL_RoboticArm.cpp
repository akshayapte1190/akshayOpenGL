...
GLUquadric *quadricSholder = NULL, *quadricElbow=NULL;
LRESULT CALLBACK WndProc(HWND, UINT, WPARAM, LPARAM);
GLint sholder = 0, elbow = 0;
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	if (fopen_s(&gpFile, "OGL_3D_Triangle_Spin.txt", "w") != 0)
	{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("OGL_3D_Triangle_Spin"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
